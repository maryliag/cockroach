...
<tr><td><a name="combine_unique_strings"></a><code>combine_unique_strings(input: <a href="string.html">string</a>[]) &rarr; <a href="string.html">string</a>[]</code></td><td><span class="funcdesc"><p>Combine string arrays into a single array with unique elements</p>
</span></td><td>Immutable</td></tr>
